...
<div class="row justify-content-center">
    <div class="col-xxl-9 col-xl-10">
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
                <h2 class="h4 fw-bold mb-1">Create New Task</h2>
                <div class="text-muted">Assign ownership, priority, and expected timing.</div>
            </div>
        </div>
                ...
                <form method="POST" action="{{ route('tasks.store') }}">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <input id="title" type="text" name="title"
                                   ...
                                   value="{{ old('title') }}"
                                   placeholder="Example: Prepare weekly operations report"
                                   required>
                            @error('title')
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="description" name="description" rows="5"
                                      ...
                                      placeholder="Add context, acceptance criteria, or links needed to complete the task.">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-text"><i class="bi bi-envelope me-1"></i>An email notification will be sent to the assigned user.</div>
                            @error('assigned_to')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-end gap-2 mt-5 pt-4 border-top">
                        ...
                        <button type="submit" class="btn btn-primary px-4">
                            <i class="bi bi-check2-circle me-2"></i>Create Task
                        </button>
                    </div>
                </form>
            </div>
